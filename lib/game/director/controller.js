...
ig.Controller = ig.Class.extend({
	...
	checkBranchGrowth: function() {
		...
		console.log('branch rand: ' + randInt);
		if (randInt === 1) {
		//	console.log('creating new branch: ' + randInt);
	...
	createNewBranch: function() {
		...
		//	else if (ig.game.tree.allBranchNodes.length < ig.game.tree.allTrunkNodes.length) {
		//		console.log('dude');
