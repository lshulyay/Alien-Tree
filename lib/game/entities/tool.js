...
EntityTool = ig.Entity.extend({
    ...
    candleActions: function() {
        ...
        if (touches === null && this.currentAnim.angle > 0) {
            ...
            if (touches.freezing || touches.childEntity.freezing) {
                var maxAngle = 90;
                ...
                if (touches.heatingCheck === 0) {
                    touches.heatingCheck = 1;
                    touches.heatLevel++;
                    console.log('heat level 1: ' + touches.heatLevel);
                }
                else if (touches.parentEntity && touches.heatingCheck === 1) {
                    touches.heatingCheck = 0;
                    touches.heatLevel++;
                    console.log('heat level 2: ' + touches.heatLevel);
                }
